...
- **Module:** `app/machine_modules/hamamatsu_dc5/` — Connection UI, `HamamatsuDC5Module` (get_frame_size, is_connected, start_acquisition worker, stop_acquisition, disconnect, get_acquisition_modes, get_integration_choices, get_current_gain=0, get_sensor_bit_depth=14).
